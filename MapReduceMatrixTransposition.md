...
#It means that the result is the key (which is the column index matrix) with all the values
#(elements of the matrix) which have the same key (i.e the same column index) 
